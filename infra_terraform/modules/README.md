...
```hcl
module "vpc" {
  source = "../../infra_terraform/modules/aws/primitives/vpc"
  name   = "my-vpc"
  cidr   = "10.0.0.0/16"
...
```bash
kubectl apply -f infra_terraform/modules/cloud_shared/k8s/api-service.yaml
kubectl apply -f infra_terraform/modules/cloud_shared/k8s/api-deployment.yaml
```
