...
War stories are split by cloud provider:

| File | Description |
|------|-------------|
| [WAR_STORIES_AWS.md](WAR_STORIES_AWS.md) | AWS-specific (EKS, ECR, CloudFront, S3, RDS, Aurora, Bedrock, etc.) |
...
| [WAR_STORIES_OTHER.md](WAR_STORIES_OTHER.md) | App / agent / local-dev lessons (Execution Log, text-to-SQL geography, tooling) |
