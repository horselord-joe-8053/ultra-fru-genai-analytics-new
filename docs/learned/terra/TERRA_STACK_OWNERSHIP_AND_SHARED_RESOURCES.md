...
A guide to **who owns what** across our Terraform stacks, how stacks **share** AWS resources, and how to avoid **tag drift** and other conflicts. Essential reading after [War Story 58: VPC Subnet Tag Drift](../../README_WAR_STORIES.md#58-vpc-subnet-tag-drift-durable-vs-kube-and-lifecycle-ignore_changes).
...
*Doc: `docs/learned/terra/TERRA_STACK_OWNERSHIP_AND_SHARED_RESOURCES.md`. Related: [FULL_ARCH_KUBE_LEARN.md](../FULL_ARCH_KUBE_LEARN.md), [VPC_LEARNED.md](../VPC_LEARNED.md), [README_WAR_STORIES.md](../../README_WAR_STORIES.md).*
