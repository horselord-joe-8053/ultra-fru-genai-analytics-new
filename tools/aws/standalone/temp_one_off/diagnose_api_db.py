...
Usage:
  ...
  python tools/aws/standalone/temp_one_off/diagnose_api_db.py --base-url http://alb-dns-name  # direct ALB
...
def main():
    ...
    try:
        ...
        if db_status == "connected":
            ...
            logger.info("  → Run: python tools/aws/scope_shared/deploy/ensure_secrets.py --env $FRU_ENV")
    ...
    logger.info("  1. python tools/aws/scope_shared/deploy/ensure_secrets.py --env $FRU_ENV  # set PGPASSWORD in Secrets Manager")
