...
# QueryStream: LLM streaming + cold start can take 60–180+ s; 5 min default to reduce flakiness
QUERY_STREAM_TIMEOUT_PER_REQUEST_SEC = get_int_env("VERIFY_QUERY_STREAM_TIMEOUT_PER_REQUEST_SEC", 300)
